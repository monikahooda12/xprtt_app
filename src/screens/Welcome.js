  ...
  return (
    ...
    <View style={{ flex: 1, backgroundColor: COLORS.PRIMARY }}>
      ...
      <ScrollView keyboardShouldPersistTaps='handled' style={{ paddingHorizontal: responsiveWidth(1.3) }}>
        ...
        <TextInput label="Name" value={user.name} onChangeText={text => handleInputChange('name', text)} />
        ...
        <View style={styles.container}>
          <SelectList label='Gender' value={user.gender && user.gender} list={gender} searchEnabled={false} getValue={text => handleInputChange('gender', text)} />
